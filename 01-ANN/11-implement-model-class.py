# This is same as 03-qwerty-classification.py
# with the differenc of creating model using
# class vs nn.Sequential.
...
class QwertyClassifier(nn.Module):
    ...
    @override
    def forward(self, x):
        x = F.relu( self.input_layer(x) ) # input layer and activation
        x = torch.sigmoid( self.output_layer(x) ) # output layer and probaility conversion
        return x
...
if __name__ == '__main__':
    ...
    # )
    AnnClassifier = QwertyClassifier()
